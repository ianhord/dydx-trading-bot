...
def open_positions(client):
    ...
    for index, row in df.iterrows():
        ...
        # Get ZScore
        if len(series_1) > 1 and len(series_1) == len(series_2):
            ...
            if abs(z_score) >= ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    # Get acceptable price in string format with correct umber of decimals
                    ...
                    # Ensure size ?? max order size to comply with dydx?
